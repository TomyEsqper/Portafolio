...
export const en: LocaleContent = {
  ...
  profile: {
    ...
    english: 'English B2',
    summary:
      'I design APIs and microservices in .NET with Clean Architecture, SOLID, and a focus on maintainable systems.',
  },
  ui: {
    ...
    about: {
      ...
      p1: 'Backend developer focused on .NET. I build REST APIs and microservices with Clean Architecture, SOLID, and Clean Code, aiming for clarity and long-term maintainability.',
      p2: 'I keep strengthening architecture, API design, and data work, while exploring cloud on AWS. I care about clean, useful, sustainable software.',
    ...
    stack: {
      ...
      lead: 'From domain to delivery: C#, APIs, data, cloud, and CI/CD.',
    },
    projects: {
      label: '04 — Projects',
      title: 'Work that speaks',
      lead: '.NET microservices and a real job platform, with focus on architecture and delivery.',
    },
    experience: {
      label: '05 — Career',
    ...
    architecture: {
      ...
      lead: 'This portfolio also shows cloud hosting and continuous delivery, without forcing unnecessary complexity.',
      flow: 'Angular build → Amazon S3 → CloudFront · PR → CI · merge to main → CD',
      points: [
        {
          title: 'Static frontend',
          body: 'Angular 19 compiles to static files. There is no app server for the UI — just HTML, CSS, JS, and assets.',
        },
        {
          title: 'S3 + CloudFront',
          body: 'S3 stores the build and CloudFront delivers it over CDN with HTTPS, caching, and SPA fallbacks for frontend routes.',
        },
        {
          title: 'CI/CD with GitHub Actions',
          body: 'Every Pull Request validates build and tests. Merging to main publishes to S3 and invalidates CloudFront.',
        },
        {
          title: 'Why not Lambda here',
          body: 'This site does not need backend compute. Lambda would fit a separate .NET API, not for serving this frontend.',
        },
      ],
    },
    certifications: {
      lead: '{{count}} certificates · They scroll on their own. Click to select one.',
      hint: 'Swipe to explore · Tap for details',
      close: 'Close',
      issued: 'Issued',
    ...
    recognitions: {
      ...
      lead: 'Awards and recognitions for applied learning and concrete results.',
  ...
  projects: [
    {
      ...
      highlights: [
        ...
        'Docker containerization and GitHub Flow workflow',
      ],
